...
class UserNotificationTest(PyonTestCase):
    ...
    def test_create_notification(self):
        ...
        self.user_notification._update_user_info_dictionary = mocksignature(self.user_notification._update_user_info_dictionary)
        ...
        notification_request = NotificationRequest(name='a name',
            origins = ['origin_1'],
            origin_types = ['origin_type_1'],
            event_types= ['event_type_1'],
            event_subtypes = ['event_subtype_1'] )
    ...
    def test_update_notification(self):
        ...
        self.user_notification._update_user_info_object = mocksignature(self.user_notification._update_user_info_object)
        self.user_notification._update_user_info_object.return_value = 'user'

        self.user_notification._update_user_info_dictionary = mocksignature(self.user_notification._update_user_info_dictionary)
        self.user_notification._update_user_info_dictionary.return_value = ''
        ...
        self.user_notification._update_user_info_object.assert_called_once_with(user_id, notification, notification)
        self.user_notification._update_user_info_dictionary.assert_called_once_with('user_id_1', notification, notification)
...
class UserNotificationIntTest(IonIntegrationTestCase):
    ...
    def test_pub_reload_user_info_event(self):
        ...
        notification_request_correct = NotificationRequest(   name= 'notification_1',
            origins= ["instrument_1"],
            origin_types= ["type_1"],
            event_types=['ResourceLifecycleEvent'])

        notification_request_2 = NotificationRequest(   name='notification_2',
            origins= ["instrument_2"],
            origin_types=["type_2"],
            event_types=['DetectionEvent'])
    ...
    def test_user_info_UNS(self):
        ...
        notification_request_correct = NotificationRequest(   name = 'notification_1',
            ...
            origin_types = ["type_1"],
            event_types = ['ResourceLifecycleEvent'],
            event_subtypes = ['subtype_1'])

        notification_request_2 = NotificationRequest(   name = 'notification_2',
            origins = ["instrument_2"],
            origin_types = ["type_2"],
            event_types = ['DetectionEvent'],
            event_subtypes = ['subtype_2'])
